...
| `G2-NAME-009` | G2 | Lab Without Department | some slot in Name 2…5 for which `is_granular_unit(v)` **and** no *other* slot in Name 2…5 satisfies `is_specific_unit_construction` or `is_unit_construction` | Name 2 | enrichment | completeness | `:1258–1267` |
