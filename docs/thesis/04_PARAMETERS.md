...
Every environment variable read anywhere in the repository — 38 rows covering 40 variables (the
final row groups the three standard proxy variables). "Breaks when unset" is read from the code
