...
| # | Marker | Source file:line | What is missing | What would resolve it | Thesis section affected |
|---|---|---|---|---|---|
| 170 | ⚠ NO FIXTURE COVERAGE → moot | `03b_EXEMPLARS.md:87` | `G1-NAME-001` "Name Overflow Across Fields" was reachable but no repository record satisfied it | Nothing: the code was withdrawn on 2026-09-07 and is no longer reachable, so no fixture is owed | Worked examples — code coverage census (Pass 3b §4); limitations G-80 |
